...
store_db = {
    ...
    '한식': {
        ...
        '유가네닭갈비': {
            'menu': {'닭갈비철판볶음밥': 9000, '치즈철판볶음밥': 9500, '유가네닭갈비': 12500, '가쓰오철판볶음밥': 9500, '치폴레와르르닭갈비(2인)': 27000,
                     '콘치즈닭갈비(2인)': 27000, '쭈닭갈비(2인)': 27000, '낙지닭갈비(2인)': 27000, '후루룩떡볶이': 6000, '어묵탕': 8500, '계란찜': 4500, 
                     '물막국수': 8000, '물비빔막국수': 8000, '스팸주먹밥': 5500, '날치마요주먹밥': 5500, '라면사리': 2500, '우동사리': 2500, '쫄면사리': 2500},
            'min_order': 18000,
            'delivery_logic': lambda p: 0, 
            'notice': '💡 18,000원 이상 무료배달'},
        '153구포국수': {
            'menu': {'153지단 김밥': 5500, '꼬마김밥 5종': 5500, '잔치국수': 8000, '비빔국수': 8500, '키토마요김밥': 6000, '부산어묵국수': 8000, 
                    '사골고기국수': 9000, '매콤고기국수': 9000, '유부어묵우동': 8000, '새우튀김우동': 8500, '칼국수': 9000, '매콤칼국수': 9500, 
                    '쫄면': 8500, '냉콩국수': 9000, '김치말이국수': 9000, '크래미마요 김밥': 5500, '매운어묵김밥': 5500, '참치마요김밥': 6000,
                    '돈까스김밥': 7000, '오징어덮밥': 9500, '제육덮밥': 9500, '만둣국+공기밥': 9000, '튀김만두': 5000, '새우튀김': 7500},
            'min_order': 15000,
            'delivery_logic': lambda p: 0, 
            'notice': '💡 15,000원 이상 무료배달'},
        '김치돼학교': {
            'menu': {'K아이돌 정식': 21800, '직화삼겹김치찜': 33900, '직화스팸&삼겹김치찜': 33900, '직화삼겹김치구이': 28900, '직화삼겹듬뿍김치찌개': 18900,
                    '직화스팸&삼겹김치찌개':18900,'고기서 삼겹 구이': 19900, '스팸마요덮밥': 5900, '맛있는 김': 1000, '윤기좔좔 고봉밥': 1500, 
                    '제로 펩시 라임': 2500, '칠성 사이다': 2500, '스프라이트': 2500, '코카콜라 제로': 2500},
            'min_order': 5000,
            'delivery_logic': lambda p: 0, 
            'notice': '💡 5,000원 이상 무료배달'}
    },
    '카페': {
        '설빙': {
        ...
        '미쉐': {
            ...
            'notice': '💡 12,000원 이상 무료배달'},
        '공차': {
            'menu':{'자몽 쥬얼리 시그니처 밀크티': 6400, '말차 쥬얼리 시그니처 밀크티': 6400, '납작복숭아 아이스티 얼그레이+미니펄': 5000, '납작복숭아 아이스티 블랙+미니펄': 5000,
                   '말차 초코 스무디': 6200, '더블 말차 밀크티': 5900, '얼그레이 말차 밀크티': 6100, '자스민 코코 with 말차폼': 5600, '딸기 초콜릿 밀크티': 5800, '딸기 가득 밀크티': 5600,
                   '아메리카노': 4200, '블랙밀크티': 5500, '타로밀크티': 5500, '제주 그린 밀크티': 6800, '초콜렛 밀크티': 5900, '블랙티': 4300, '얼그레이티': 4300, '우롱티': 4300,
                   '자스민티': 4300, '자몽 자스민티': 5100, '청포도 자스민티':5100, '패션 프룻 히비스커스': 5100, '망고 요구르트': 5500},
            'min_order': 11000,
            'delivery_logic': lambda p: 0, 
            'notice': '💡 11,000원 이상 무료배달'},
        '메가커피': {
            'menu':{'왕메가카페라떼': 4400, '할메가미숫커피': 2900, '할메가커피': 2100, '아메리카노': 2500, '큐브라떼': 4200, '메가리카노': 3300, 
                   '복숭아아이스티': 3500, '쿠키프라페': 4400, '감자빵세트': 5200, '꿀수박주스': 4000, '수박 리치코코 슬러시': 4000, '자몽 톡통 스무디': 4000, 
                   '제로 레몬말차 아이스티': 2400, '팥빙 젤라또 파르페': 4400, '말차 젤라또 팥빙 파르페': 4400, '애플머스캣 요거트 스무디': 3900, '딸기라떼': 3700,
                   '밀크쉐이크': 2900, '유자생강차': 3300, '요거젤라또 초코베리믹스': 3900, '메가베리 아사이볼': 3900, '왕메가사과유자차': 4400},
            'min_order': 12000,
            'delivery_logic': lambda p: 0, 
            'notice': '💡 12,000원 이상 무료배달'},
        '빽다방': {
            'menu':{'아메리카노': 2300, '카페라떼': 3700, '바닐라라떼': 4200, '빽사이즈 아메리카노': 3800, '우베라떼': 4000, '우베 요거트 아이스크림': 5200, 
                    '토마토 담은 주스': 4500, '우리수박주스': 4500, '통단팥쉐이크': 5200, '제로슈거레몬티': 4000, '제로슈거자몽티': 4000, '요거트 아이스크림': 4200,
                   '레드불꿀샷추': 5300, '바나나카페라떼': 4600, '콜드브루': 4500, '디카페인 아메리카노': 2900, '체리콕콕': 4000, '깔라만시에이드': 4300, '레모네이드': 4500},
            'min_order': 12000,
            'delivery_logic': lambda p: 0, 
            'notice': '💡 12,000원 이상 무료배달'}
    },
     '양식': {
        ...
        '맘스터치': {
            ...
            'notice': '💡 15,000원 이상 무료배달'},
         '샐러디': {
            'menu':{'로스트닭다리살샐러드': 11400, '멕시칸 랩': 8300, '우삼겹메밀면 누들볼': 10700, '탄단지 샐러드': 9900, '에그마요 랩': 6300, '고추간장 당근 국수': 9100, 
                   '고추간장 취나물 비빔밥': 9100, '트러플 들깨크림 파스타': 14800, '청양라구 파스타': 14300, '클래식 치킨 샌드위치': 6800, '불고기 반미 샌드위치': 8500,
                   '그라브락스 연어 샐러드': 13700, '노릇두부단호박 샐러드': 10600, '고소삼겹 들기름파스타 누들볼': 10700, '우삼겹 포케':10800, '양송이 크림스프': 5200,
                   '단호박 크림스프': 5600, '아메리카노': 3100, '애사비 사과 스파클링': 3000, '착즙주스': 5200},
            'min_order': 12500,
            'delivery_logic': lambda p: 0, 
            'notice': '💡 12,500원 이상 무료배달'},
        }
}
# [핵심] 최적 조합 계산 함수
