...
store_menu_data = {
    ...
    '써브웨이': {'베지': 6000, '에그슬라이스': 6300, '참치': 7100, '머쉬룸': 7300, '치킨슬라이스': 7500, '비엘티': 8000, 
              ...
              '피자썹': 5200, '잠봉': 8300, '로스트치킨': 8700, '오늘의 수프(하프)': 3200, '쿠키(3개입)': 5500, '칩(랜덤발송)': 1900,
              '바리스타룰스 아메리카노(350ml)': 3300, '코카콜라 제로(355ml)': 2900, '스프라이트(355ml)': 2900, '닥터페퍼(355ml)': 2900, '쿠키팩(6개)': 10800},
